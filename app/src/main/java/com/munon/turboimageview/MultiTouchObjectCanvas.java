...
public interface MultiTouchObjectCanvas<T> {
    ...
    public void removeObject(T obj, PointInfo touchPoint);
    public void deselectObject(T obj, PointInfo touchPoint);
    public void flipObject(T obj, PointInfo touchPoint);
    public void aheadObject(T obj, PointInfo touchPoint);
    public void behindObject(T obj, PointInfo touchPoint);
