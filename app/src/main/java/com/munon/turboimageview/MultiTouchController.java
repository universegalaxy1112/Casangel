        ...
        switch (mMode) {
            ...
            case MODE_DRAG:
                if (!mCurrentTouchPoint.isDown()) {
                    ...
                    setMode(MODE_NOTHING);
                    MultiTouchObject multiTouchObject = (MultiTouchObject) selectedObject;
                    if(
                            ((multiTouchObject.cancelPointX - multiTouchObject.res.getDimension(R.dimen.dip_20)) < mCurrentTouchPoint.getX() && mCurrentTouchPoint.getX() < (multiTouchObject.cancelPointX + multiTouchObject.res.getDimension(R.dimen.dip_20))) && // check if in X
                                    ((multiTouchObject.cancelPointY - multiTouchObject.res.getDimension(R.dimen.dip_20)) < mCurrentTouchPoint.getY() && mCurrentTouchPoint.getY() < (multiTouchObject.cancelPointY + multiTouchObject.res.getDimension(R.dimen.dip_20)))) // check if in Y
                    {
                        objectCanvas.removeObject(selectedObject, mCurrentTouchPoint);
                    }
//                    else if(((multiTouchObject.donePointX - TOUCH_AREA) < mCurrentTouchPoint.getX() && mCurrentTouchPoint.getX() < (multiTouchObject.donePointX + TOUCH_AREA)) && // check if in X
//                            ((multiTouchObject.donePointY - TOUCH_AREA) < mCurrentTouchPoint.getY() && mCurrentTouchPoint.getY() < (multiTouchObject.donePointY + TOUCH_AREA))){
//                        //objectCanvas.deselectObject(selectedObject, mCurrentTouchPoint);
//                    }
                    else if(((multiTouchObject.flipBtnCenterX - multiTouchObject.res.getDimension(R.dimen.dip_10)) < mCurrentTouchPoint.getX() && mCurrentTouchPoint.getX() < (multiTouchObject.flipBtnCenterX + multiTouchObject.res.getDimension(R.dimen.dip_10))) && // check if in X
                            ((multiTouchObject.flipBtnCenterY - multiTouchObject.res.getDimension(R.dimen.dip_50) / 2) < mCurrentTouchPoint.getY() && mCurrentTouchPoint.getY() < multiTouchObject.flipBtnCenterY + multiTouchObject.res.getDimension(R.dimen.dip_50) / 2)){
                        objectCanvas.flipObject(selectedObject, mCurrentTouchPoint);
                    }
                    else if(((multiTouchObject.aheadBtnCenterX - multiTouchObject.res.getDimension(R.dimen.dip_30)) < mCurrentTouchPoint.getX() && mCurrentTouchPoint.getX() < (multiTouchObject.aheadBtnCenterX + multiTouchObject.res.getDimension(R.dimen.dip_30))) && // check if in X
                            ((multiTouchObject.aheadBtnCenterY - multiTouchObject.res.getDimension(R.dimen.dip_20)) < mCurrentTouchPoint.getY() && mCurrentTouchPoint.getY() < multiTouchObject.aheadBtnCenterY + multiTouchObject.res.getDimension(R.dimen.dip_20))){
                        objectCanvas.aheadObject(selectedObject, mCurrentTouchPoint);
                    }
                    else if(((multiTouchObject.behindBtnCenterX - multiTouchObject.res.getDimension(R.dimen.dip_30)) < mCurrentTouchPoint.getX() && mCurrentTouchPoint.getX() < (multiTouchObject.behindBtnCenterX + multiTouchObject.res.getDimension(R.dimen.dip_30))) && // check if in X
                            ((multiTouchObject.behindBtnCenterY - multiTouchObject.res.getDimension(R.dimen.dip_20)) < mCurrentTouchPoint.getY() && mCurrentTouchPoint.getY() < multiTouchObject.behindBtnCenterY + multiTouchObject.res.getDimension(R.dimen.dip_20))){
                        objectCanvas.behindObject(selectedObject, mCurrentTouchPoint);
                    }
                    else {
                        objectCanvas.selectObject((selectedObject = null), mCurrentTouchPoint);
                    }
